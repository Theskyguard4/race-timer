...
const { getRaces, getRunnersByRace, editRunner, getRacePositions, getStartTime, addRace, addRaceResults, addSingleRaceResult, removeSinglePositionViaReButt, endRace, saveEntireRace} = require('../controllers/raceController');
...
router.post('/races/removeSinglePositionViaReButt', removeSinglePositionViaReButt)
